...
scren = pygame.display.set_mode((800, 600), 0)
...
class Cenario(ElementoJogo):
    def __init__(self, tamanho, pac):
        ...
        # Estado possiveis 0-Jogando 1-Pausado 2-GameOver 3-Vitoria
        self.estado = 0
        self.matriz = [
    ...
    def pintar_texto_centro(self, tela, texto):
        ...
        text_x = (tela.get_width() - texto_img.get_width()) // 2
        text_y = (tela.get_height() - texto_img.get_height()) // 2
        tela.blit(texto_img, (text_x, text_y))
...
class Pacman(ElementoJogo, Movivel):
    ...
    def pintar(self, tela):
        ...
        self.abertura += self.velociade_abertura
...
class Fantasma(ElementoJogo):
    ...
    def pintar(self, tela):
        ...
        pygame.draw.circle(
            tela, BRANCO, (olho_e_x, olho_e_y), olho_raio_ext, 0)
        pygame.draw.circle(tela, PRETO, (olho_e_x, olho_e_y), olho_raio_int, 0)

        pygame.draw.circle(
            tela, BRANCO, (olho_d_x, olho_d_y), olho_raio_ext, 0)
